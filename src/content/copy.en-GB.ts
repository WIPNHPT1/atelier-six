export const copy = {
  ...
  settings: {
    ...
    reportProblemHint:
      'Opens a GitHub issue in a new tab with app details filled in. You can check and edit everything before you submit; nothing is sent automatically.',
    reportProblemAction: 'Report',
    about: 'About Atelier Six',
    aboutHint: 'How it works, how it was built and your privacy.',
    aboutAction: 'Read',
  },
  pwa: {
  ...
  about: {
    title: 'About',
    pageTitle: 'About Atelier Six',
    lede: 'Chords are easy. Changes are hard.',
    problemHeading: 'The problem',
    problem:
      'Any chord chart shows you where your fingers go for one shape. None of them show you how to get to the next shape without a gap in the music, and that gap is what makes a song fall apart. Atelier Six plans every change, which fingers stay, which slide and which lift, then drills the changes you find hardest.',
    demoHeading: 'One change, planned',
    demoCaption: 'G to C: the engine keeps what it can and moves the rest together.',
    engineHeading: 'How the fingering engine works',
    engine:
      'Each chord can be played several ways. The engine lays every option out as a column, prices each shape and every move between shapes, and finds the cheapest path through them. Pick two chords to see it.',
    fromChord: 'First chord',
    toChord: 'Second chord',
    latticeLabel: 'Candidate shapes for {from} and {to}, with the chosen path highlighted',
    shapeCost: 'shape {cost}',
    chosenPath: 'Chosen: {from} to {to}, change cost {cost}.',
    engineLink: 'Read the full engine write-up',
    designHeading: 'The design',
    design:
      'A monochrome, glassy design system with five finishes you can switch between in Settings. Every colour pair is checked for 4.5:1 contrast and every animation respects reduced motion.',
    finishesLabel: 'Finishes',
    screenMobile: 'Atelier Six on a phone',
    screenDesktop: 'Atelier Six on a desktop',
    ...
    privacy:
      'No account and no tracking. Settings and progress stay on this device. The tuner listens in the browser and never records or sends audio.',
    linksHeading: 'Links',
    linkRepo: 'Source code on GitHub',
    linkEngine: 'Engine write-up',
    linkAdrs: 'Architecture decisions',
    notAffiliated:
