export const copy = {
  ...
  course: {
    ...
    playAlongWith: 'Play along with {song}',
    playAlongSet: 'Set to {tuning}, capo {capo}. Start your copy of the song, then tap along.',
    tap: 'Tap with the song',
    tapped: '{bpm} bpm',
    tapFirst: 'Tap at least twice to set the tempo.',
    loopTechnique: 'Loop {title} at this tempo',
  ...
  fun: {
    ...
    yes: 'Yes',
    no: 'Not really',
    thanks: 'Thanks, noted. This stays on your device.',
