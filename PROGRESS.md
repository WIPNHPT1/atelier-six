...
- [x] 6.1 Lesson data
- [x] 6.2 Lesson player + arrangement
- [x] 6.3 Drills
- [x] 6.4 Adaptive tempo
- [x] 6.5 Progress storage + heatmap
- [x] 6.6 Practice planner
- [x] 6.7 Module tunes + riffs of the week
- [x] 6.8 Fun and feel
- [x] 6.9 Foundations module + hand health
- [x] Gate 6 (includes your listening review: Power 5/5/5, Open 5/5/5)
...
- [x] 8.2 Voice commands
- [x] 8.3 Left-handed, tunings, finishes everywhere
- [x] Gate 8
...
- [x] 9.5 Budgets, Lighthouse CI, axe
- [x] 9.6 Visual regression tests
- [x] Gate 9
  - Device check (2026-09-26, user's own devices via `docs/device-checklist.md`): live site
    installs and runs fully offline ✓ ("it worked").
